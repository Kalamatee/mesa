/*
    ...
    $Id: mesa3dgl_glacreatecontext.c 50858 2015-06-23 22:30:34Z NicJA $
*/
...
*****************************************************************************/
{
    ...
    D(bug("[MESA3DGL] %s:   _bmap @ 0x%p\n", __PRETTY_FUNCTION__, pscreen_tags[0].ti_Data));
    ...
    D(bug("[MESA3DGL] %s: ST Manager @ 0x%p \n", __PRETTY_FUNCTION__, ctx->stmanager));
